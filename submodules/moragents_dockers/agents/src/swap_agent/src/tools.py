...
def swap_coins(token1, token2, amount, chain_id, wallet_address, interval):
    ...
    return [
        {
            ...
            "function": {
                "name": "swap_agent",
                "description": "swap two cryptocurrencies once or on an interval (number of milliseconds)",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "token1": {
                        ...
                        "interval": {
                            "type": "string",
                            "description": "number of milliseconds between a recurring swap",
                        },
                    },
                    "required": ["token1", "token2", "value", "interval"],
                },
            },
        }
    ]
